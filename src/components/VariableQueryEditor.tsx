...
const TYPE_OPTIONS: Array<ComboboxOption<MeshIqVariableQueryType>> = [
  { label: 'Items', value: 'tables', description: 'List items (jKQL: get items)' },
  { label: 'Fields', value: 'fields', description: "List an item's fields (jKQL: get fields for <table>)" },
    ...
    <>
      ...
      {model.type === 'fields' && (
        <InlineField
          label="Item"
          labelWidth={20}
          tooltip="Item whose fields become the values"
          invalid={tablesError}
          error={tablesError ? 'Could not load items' : undefined}
        >
          <Combobox
