        ...
        <>
          {repositoriesOptions.length > 0 && (
            <InlineField
              ...
              error="Choose a default repository"
              tooltip="Repository used by default; can be overridden per query"
            >
              <Combobox
                ...
                invalid={!jsonData.repositoryID}
                placeholder="Choose a default repository"
                width={40}
              />
            </InlineField>
          )}
          {serviceVersion && (
            <InlineField
              ...
              labelWidth={28}
              disabled
              tooltip="Dataservice version reported by the server."
            >
          ...
          <InlineField
            ...
            labelWidth={28}
            disabled
            tooltip="Server-side maximum result rows."
          >
