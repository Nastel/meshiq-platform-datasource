...
// TestRejectCrossHostRedirect_SameHostAllowed pins that a same-host redirect (e.g. the
// dataservice itself issuing a 307 for its own reasons) is still followed.
