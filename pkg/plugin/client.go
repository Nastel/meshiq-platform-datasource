...
const maxResponseBodyBytes = 100 * 1024 * 1024 // 100 MiB

// errResponseTooLarge is returned when a response body exceeds maxResponseBodyBytes.
var errResponseTooLarge = fmt.Errorf("dataservice response exceeded the %d MiB limit", maxResponseBodyBytes/(1024*1024))
